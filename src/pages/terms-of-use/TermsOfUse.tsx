const TermsOfUse = () => {
  return (
    <div className="pt-[7%] px-[10%] bg-[#f0f0f0]">
      <div className="bg-white pt-[10%] px-[10%] pb-[10%] flex flex-col gap-1 text-black">
        <h2>
          <strong className="text-[16px] font-bold text-black">
            Terms and Conditions
          </strong>
        </h2>
        <p className="text-[#6C6C6C] font-normal text-[12px]">
          {" "}
          Last updated: April 20th, 2023
        </p>
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">P</span>lease read these terms and conditions
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">T</span>he words of which the initial letter is
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-1">F</span>or the purposes of these Terms and
          Conditions:
        </p>
        <ul className="list-disc ml ml-5">
          <li className="text-[12px] text-black font-normal">
            <strong className="text-[12px] font-bold text-black">
              Application
            </strong>{" "}
            means the software program provided by the Company downloaded by You
            on any electronic device, named{" "}
          ...
          <li className="text-[12px] text-black font-normal">
            ...
            Agreement) refers to INTERNATIONAL TELECOM SOLUTIONS AND TRADING
            COMPANY LIMITED, Tầng 3, số 33 Trung Kính, Phường Trung Hoà, Quận
            Cầu Giấy, Thành phố Hà Nội, Việt Nam.
          </li>
          <li className="text-[12px] text-black font-normal">
            <strong className="text-[12px] font-bold text-black">Device</strong>{" "}
          ...
          <li className="text-[12px] text-black font-normal">
            ...
            with the help of the TermsFeed{" "}
            <a
              className="underline"
          ...
          <li className="text-[12px] text-black font-normal">
            - <strong className="text-[12px] font-bold text-black">You</strong>{" "}
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">T</span>hese are the Terms and Conditions
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">Y</span>our access to and use of the Service is
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">B</span>y accessing or using the Service You
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">Y</span>ou represent that you are over the age
          of 18. The Company does not permit those under 18 to use the Service.
        </p>
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">Y</span>our access to and use of the Service is
          also conditioned on Your acceptance of and compliance with the Privacy
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">O</span>ur Service may contain links to
          third-party web sites or services that are not owned or controlled by
          the Company.
        </p>
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">T</span>he Company has no control over, and
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">W</span>e strongly advise You to read the terms
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">W</span>e may terminate or suspend Your access
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">N</span>otwithstanding any damages that You
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">T</span>o the maximum extent permitted by
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">S</span>ome states do not allow the exclusion
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">T</span>he Service is provided to You "AS IS"
          and "AS AVAILABLE" and with all faults and defects without warranty of
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">W</span>ithout limiting the foregoing, neither
          the Company nor any of the company's provider makes any representation
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">S</span>ome jurisdictions do not allow the
          ...
          and limitations may not apply. But in such a case the exclusions and
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">T</span>he laws of the Country, excluding its
          conflicts of law rules, shall govern this Terms and Your use of the
          Service. Your use of the Application may also be subject to other
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">I</span>f You have any concern or dispute about
          the Service, You agree to first try to resolve the dispute informally
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">I</span>f You are a European Union consumer,
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">Y</span>ou represent and warrant that (i) You
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">I</span>f any provision of these Terms is held
        ...
        <h4>
          {" "}
          <strong className="text-[12px] font-bold text-black">Waiver</strong>
        </h4>
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">E</span>xcept as provided herein, the failure
          to exercise a right or to require performance of an obligation under
          these Terms shall not effect a party's ability to exercise such right
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">T</span>hese Terms and Conditions may have been
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">W</span>e reserve the right, at Our sole
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-2">B</span>y continuing to access or use Our
        ...
        <p className="text-[12px] text-black font-normal">
          <span className="ml-1">I</span>f you have any questions about these
          Terms and Conditions, You can contact us:
        </p>
        <ul className="list-disc ml ml-5">
          <li className="text-[12px] text-black font-normal">
            By email:{" "}
            <a href="mailto:CFITECH-INTES@gmail.com">CFITECH-INTES@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
