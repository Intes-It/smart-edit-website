const TermsOfUse = () => {
  return (
    <div className="pt-[7%] px-[10%] bg-[#f0f0f0]">
      <div className="bg-white pt-[10%] px-[10%] pb-[10%] flex flex-col gap-3 text-black">
        <h2>
          <strong>Terms and Conditions</strong>
        </h2>
        <p className="text-[#6C6C6C]"> Last updated: April 20th, 2023</p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to INTERNATIONAL TELECOM
            SOLUTIONS AND TRADING COMPANY LIMITED, Tầng 3, số 33 Trung Kính,
